...
public class FarmerTradingHelper extends AbstractTradingHelper
{
	...
	{
		return TradyConfig.TWEAKM_TRADY_FARMER.getBooleanValue() && (this.testProfession("entity.minecraft.villager.farmer") || this.container.getRecipes().size() >= 1 && this.container.getRecipes().get(0).getAdjustedFirstBuyItem().getItem() == Items.WHEAT);
	}
