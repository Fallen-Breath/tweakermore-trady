...
import me.fallenbreath.tweakermore.trady.mixins.tweakmTrady.ContainerScreenAccessor;
import me.fallenbreath.tweakermore.trady.mixins.tweakmTrady.MerchantScreenAccessor;
...
//			System.out.println("trade try #" + counter);
	...
	protected boolean canTrade(TradeOffer offer, boolean doLog)
	{
		...
		if (!canReceiveOutput(offer.getSellItem()) && !TradyConfig.TRADY_THROW_IF_FULL.getBooleanValue())
		{
